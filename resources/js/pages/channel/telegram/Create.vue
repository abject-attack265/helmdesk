<!--
  Telegram 渠道创建页，使用 ShowCreateTelegramChannelPagePropsData 填写渠道信息和接待方案。
-->
  ...
  <div class="contents">
    ...
    <div class="px-4 py-6 sm:px-6">
      <div class="space-y-6">
        ...
        <HeadingSmall
          :title="t('添加 Telegram 渠道')"
          :description="t('先填写基本信息，添加后再连接 Telegram 机器人。')"
        />
