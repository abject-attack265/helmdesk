...
return [
    ...
    'call_purposes' => [
        ...
        'reception_reply' => 'Reception Reply',
        'conversation_summary' => 'Conversation Summary',
        'conversation_tags' => 'Conversation Tagging',
        'conversation_subject' => 'Conversation Subject',
        'contact_handoff_brief' => 'Customer Context Summary',
        'contact_attributes' => 'Contact Field Extraction',
        'reply_polish' => 'Reply Polish',
        'assistant' => 'AI Assistant',
        'experience_extraction' => 'Experience Extraction',
    ],
    'call_status' => [
        'success' => 'Success',
        'error' => 'Failed',
    ...
    'chat' => [
        ...
        'model_unavailable' => 'This app does not have an available AI model. Please contact an administrator.',
